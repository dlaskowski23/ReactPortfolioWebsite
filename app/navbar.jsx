      ...
      <nav className="font-bold bg-gray-400 text-black p-4 sticky top-0 z-50">
          <div className="flex justify-between items-center container mx-auto">
            <div className="hidden md:flex flex-1 items-center justify-center space-x-8">
              ...
              <a href="#education" className="hover:text-gray-300">Skills</a>
              <a href="#skills" className="hover:text-gray-300">Projects</a>
              <a href="#projects" className="hover:text-gray-300">Education</a>
